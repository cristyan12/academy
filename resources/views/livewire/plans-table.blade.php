<div>
    <div class="w-full flex pb-10">
        ...
        <div class="pt-2 relative mx-1">
            <button wire:click="resetFilters" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring ring-gray-300 disabled:opacity-25 transition ease-in-out duration-150"
            >x</button>
        </div>
    </div>
    @if($plans->isNotEmpty())
                                ...
                                <td width="10px" class="px-6 py-2 border-b border-gray-200 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex px-4 py-1 text-right sm:px-6">
                                        <div class="flex-auto flex space-x-3">
                                            ...
                                            <button wire:click="destroy({{ $plan->id }})" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:border-indigo-300">
